package ru.kode.android.app.quality.plugin.core.api.extension
...
import ru.kode.android.app.quality.plugin.core.api.container.AppQualityDomainObjectContainer
import ru.kode.android.app.quality.plugin.core.enity.ExtensionInput
import ru.kode.android.app.quality.plugin.core.util.buildVariant
import ru.kode.android.app.quality.plugin.core.util.common
 ...
 *
 * @see AppQualityDomainObjectContainer For the custom container implementation used by this extension
 * @see NamedDomainObjectContainer For the standard Gradle container interface
 *
 * @sample
 * ```kotlin
 * class MyExtension : AppQualityConfigurableExtension() {
 *     // Extension properties and methods
 * }
 * ```
 */
open class AppQualityConfigurableExtension {
    /**
     ...
     *
     * This method registers a configuration action that will be applied to all build variants
     * using the [AppQualityDomainObjectContainer] abstraction. It's particularly useful
     ...
     * @sample
     * ```kotlin
     * val myContainer = AppQualityDomainObjectContainer(MyType::class.java, project.objects)
     * extension.common(myContainer) {
     *     // Common configuration for all build types
     *     someProperty = "common-value"
     * }
     ...
     */
    protected fun <T : Any> common(
        container: AppQualityDomainObjectContainer<T>,
        configurationAction: Action<in T>,
    ) {
        container.common(configurationAction)
    }
     ...
     *
     * This method registers a configuration action that will be applied only to the specified
     * build variant using the [AppQualityDomainObjectContainer] abstraction. It's particularly
