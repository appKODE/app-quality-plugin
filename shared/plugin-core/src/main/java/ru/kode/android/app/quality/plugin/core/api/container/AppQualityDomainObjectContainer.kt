package ru.kode.android.app.quality.plugin.core.api.container
 ...
 *
 * The container is designed to work with the [AppQualityConfigurableExtension] to provide a fluent,
 ...
 * @see AppQualityConfigurableExtension For the extension that typically uses this container
 *
 * @sample
 * ```kotlin
 * // Create a container for your configuration type
 * val container = AppQualityDomainObjectContainer<MyConfig>(
 ...
 * ```
 */
class AppQualityDomainObjectContainer<T : Any>(
