package ru.kode.android.app.quality.plugin.core.logger
...
abstract class LoggerService
    ...
    constructor(
        ...
        private val loggerProvider: Provider<PluginLogger> =
            providerFactory.provider { Logging.getLogger("AppQuality") }
                .zip(parameters.verboseLogging) { logger, verboseLogging ->
                    DefaultPluginLogger(logger, verboseLogging, false)
                }
